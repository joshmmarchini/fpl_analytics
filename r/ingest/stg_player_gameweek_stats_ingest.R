...
###############################################################################
# Script Name: stg_playergameweek_stats.R
# Date: 2024-10-3
...
read_gw_base <- function(n) {
  csv_path <- file.path(root, paste0("GW", n), "player_gameweek_stats.csv")
...
# Export to csv
write.csv(df,
          "C:/dev/fpl_analytics/data/processed/stg_player_gameweek_stats.csv",
          row.names = FALSE)
